...
public class UseRenderingPlugin : MonoBehaviour {
	...
	private void CreateTextureAndPassToPlugin()
	{
		...
		*/
        ...
        SetTextureFromUnity(targetRenderTexture.GetNativeTexturePtr(), targetRenderTexture.width, targetRenderTexture.height);
        Debug.LogFormat("{0}", targetCamera.targetTexture.format);
    }
	...
	private IEnumerator CallPluginAtEndOfFrames()
	{
		while (isActiveAndEnabled) {
			...
			SetTimeFromUnity (Time.timeSinceLevelLoad * speed);
